...
const analysis = {
  ...
  policy: {
    ...
    rules: [
      ...
      {role: 'terminal', description: 'Получает, но исходящих нет при достаточном запасе наблюдения; накопление от 2 плательщиков или от 500 000 ₸.', thresholds: {min_margin_days: {value: 7, unit: 'дней после последнего поступления', rationale: 'Синтетика.'}, min_payers: {value: 2, unit: 'разных плательщиков', rationale: 'Синтетика.'}, min_in_kzt: {value: 500000, unit: 'тенге поступлений', rationale: 'Синтетика.'}}},
