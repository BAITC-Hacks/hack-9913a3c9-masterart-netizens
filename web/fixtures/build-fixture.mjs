...
const analysis = {
  ...
  policy: {
    version: 'fixture-0',
    rules: [
      {role: 'consolidator', description: 'Много разных плательщиков у одного счёта.', thresholds: {min_distinct_payers: 7}},
      {role: 'transit', description: 'Отдаёт примерно столько же, сколько получил.', thresholds: {pass_through_min: 0.8, pass_through_max: 1.2}},
      {role: 'distributor', description: 'Много разных получателей у одного счёта.', thresholds: {min_distinct_recipients: 10}},
      {role: 'terminal', description: 'Получает, но исходящих нет при достаточном запасе наблюдения.', thresholds: {max_depth: 3, min_observation_days: 7}},
      {role: 'coordinator', description: 'Связывает несколько групп и исходных клиентов.', thresholds: {min_seed_payers: 2, min_groups: 3}},
      {role: 'peripheral', description: 'Признаков других ролей не найдено.', thresholds: {}},
    ],
