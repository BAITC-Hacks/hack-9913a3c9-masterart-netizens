...
4. Запустите проверки из раздела 8: 195 проверок анализа, сервера, ассистента, импорта и PDF и
   116 проверок интерфейса.
...
В чистой копии этой версии прошли все 195 проверок анализа, сервера, ассистента, импорта и
PDF-справок и 116 проверок интерфейса (просмотрщик — 48, ассистент — 25, сохранённые счета — 33,
импорт — 10), включая прогон на данных организаторов.
