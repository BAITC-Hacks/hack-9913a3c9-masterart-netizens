...
4. Запустите проверки из раздела 8: 169 проверок анализа, сервера, ассистента и PDF и 73 проверки
   интерфейса.
...
| Карточка счёта | Роль, два-три факта с порогом правила, альтернатива, потоки, пробелы данных; справка в Markdown из просмотрщика и PDF-справка по одному или нескольким счетам |
| Оценка полноты | Для каждого наблюдения указано, каких данных не хватает; счета сгруппированы по трём видам запросов |

В интеграции и пока не входят в эту версию: история ассистента во всплывающем окне, короткий список
счетов для проверки и выбор периода дат в интерфейсе.
...
путей. Запущенный просмотрщик отдаёт ту же справку по запросу `POST /api/report`.
...
В чистой копии этой версии прошли все 169 проверок анализа, сервера, ассистента и PDF-справок,
48 проверок просмотрщика и 25 проверок панели ассистента, включая прогон на данных организаторов.
