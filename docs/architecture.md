...
На данных организаторов анализ занимает 0,3–0,4 с при повторном запуске и около 1,7 с при
первом запуске в новой среде; пиковая память — около 140 МБ (Apple M4 Max, Python 3.14). Предел задания — пять минут. Что изменится при миллионе счетов, описано в README,
раздел 10.
