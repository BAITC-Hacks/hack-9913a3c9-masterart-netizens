...
| Масштабируемость до ~1 млн узлов — текстом | [`README · раздел 10`](README.md#L293) | — | Раздел 10 README | готово |
...
| README: одна команда, критерии и пороги, выходы, ограничения, масштабирование | [`раздел 7`](README.md#L193), [`раздел 4`](README.md#L82), [`раздел 9`](README.md#L270), [`раздел 10`](README.md#L284) | готово |
...
| Схема решения: данные → метрики → роли → интерфейс | [`README · раздел 6`](README.md#L167), [`docs/architecture.md`](docs/architecture.md) | готово |
