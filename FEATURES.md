...
| Масштабируемость до ~1 млн узлов — текстом | [`README · раздел 10`](README.md#L288) | — | Раздел 10 README | готово |
...
| README: одна команда, критерии и пороги, выходы, ограничения, масштабирование | [`раздел 7`](README.md#L188), [`раздел 4`](README.md#L82), [`раздел 9`](README.md#L265), [`раздел 10`](README.md#L279) | готово |
...
| Схема решения: данные → метрики → роли → интерфейс | [`README · раздел 6`](README.md#L162), [`docs/architecture.md`](docs/architecture.md) | готово |
